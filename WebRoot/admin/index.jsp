...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <frameset cols="187,*" frameborder="no" border="0" framespacing="0">
	    ...
	    <frame src="<%=path %>/admin/right.jsp" name="rightFrame" id="rightFrame" title="rightFrame" />
  </frameset> 
  <frame src="<%=path %>/admin/down.jsp" name="bottomFrame" scrolling="no" noresize="noresize" id="bottomFrame" title="bottomFrame" />
  </frameset>
<noframes><body>
</body></noframes>

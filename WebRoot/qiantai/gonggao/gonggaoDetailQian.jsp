	...
	<div class="fwmain_nright r mTop10">
    	<div style="width:760px;margin-top: 1px;padding-bottom:10px;margin-left: -15px;">
	      <%-- <div style="height:26px;background:url(<%=path %>/images/guang.jpg);font-size: 14px;color:#de3237;">
	         <span style="float:left;font-family: 微软雅黑;font-size: 13px;margin-top: 3px;margin-left: 10px;color: white">公告</span>
	      ...
	      <div style="height: 100%;border:1px solid #FFAF60">
	              <table width="100%" border="0">
							    <tr>
							       <td align="left">公告名称：${requestScope.gonggao.biaoti }<hr/></td>
							    </tr>
							    <tr>
							       <td align="left" style="word-break:break-all;">公告内容：<c:out value="${requestScope.gonggao.neirong }" escapeXml="false"></c:out><hr/></td>
							    </tr>
							    <tr>
							       <td align="left">发布时间:${requestScope.gonggao.shijian }<hr/></td>
							    </tr>
				  </table>
	      </div>
	 </div>
